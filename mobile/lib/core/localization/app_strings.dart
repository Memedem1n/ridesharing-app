...
class AppStrings {
  ...
  static const _strings = <String, Map<String, String>>{
    'tr': {
      'app_title': 'Paylaşımlı Yolculuk',
      'nav_home': 'Ana Sayfa',
      'nav_search': 'Ara',
      'nav_bookings': 'Rezervasyonlar',
      'nav_messages': 'Mesajlar',
      'nav_profile': 'Profil',
      'action_create_trip': 'İlan Ver',
      ...
      'logout_confirm_message': 'Hesabınızdan çıkış yapmak istediğinize emin misiniz?',
      'cancel': 'İptal',
      'confirm': 'Onayla',
    },
    'en': {
      'app_title': 'Ridesharing',
      'nav_home': 'Home',
      'nav_search': 'Search',
      'nav_bookings': 'Bookings',
      'nav_messages': 'Messages',
      'nav_profile': 'Profile',
      'action_create_trip': 'Offer Ride',
    ...
    'ar': {
      'app_title': 'مشاركة الرحلات',
      'nav_home': 'الرئيسية',
      'nav_search': 'بحث',
      'nav_bookings': 'الحجوزات',
      'nav_messages': 'الرسائل',
      'nav_profile': 'الملف الشخصي',
      'action_create_trip': 'أضف رحلة',
