          ...
          children: [
                ...
                children: [
                  Row(
                    children: [
                      ...
                      SizedBox(width: 8),
                      Text('Destek Merkezi', style: TextStyle(color: AppColors.textPrimary, fontSize: 18, fontWeight: FontWeight.bold)),
                    ],
                  ),
                  SizedBox(height: 8),
                  Text('Canli operasyonda 09:00-23:00 arasi ortalama ilk yanit suresi 7 dakikadir.', style: TextStyle(color: AppColors.textSecondary)),
                  SizedBox(height: 8),
                  Text('Not (2026-02-09): Bu icerik gecici demo metnidir; operasyon ekibi metinleri sonradan netlestirecek.', style: TextStyle(color: AppColors.warning, fontSize: 12)),
                ],
              ),
            ),
            ...
            GlassContainer(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('Iletisim Kanallari', style: TextStyle(color: AppColors.textPrimary, fontWeight: FontWeight.bold)),
            ...
            GlassContainer(
              ...
              child: const Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Sik Sorulan Sorular', style: TextStyle(color: AppColors.textPrimary, fontWeight: FontWeight.bold)),
                  SizedBox(height: 10),
                  _FaqTile(
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(q, style: const TextStyle(color: AppColors.textPrimary, fontWeight: FontWeight.w600)),
